...
$this->breadcrumbs=array(
	'Boleta de Notas'=>array('index'),
	//$model->id,
	//$model->apellidosnombres,
	$model->codalumno,
);
?>
<!-- Split button -->
...
<div class="alert alert-success" role="alert">
  ...
  <a href="#" class="alert-link">Bienvenido, <?php echo $model->apellidosnombres; ?></a>
...
<div class="panel panel-default">
  ...
  <button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> <span class="glyphicon-class"><a  href="/wcalificaciones/wd/site/imprimir/<?php echo $model->codalumno."#".base64_encode(time()); ?>" target="_blank">Imprimir</a></span> </button>
 <button type="button" class="btn btn-success"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> <span class="glyphicon-class"><a  href="/wcalificaciones/wd/site/pdf/<?php echo $model->codalumno."#".base64_encode(time()); ?>" target="_blank">Exportar a PDF</a></span></button>
<button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> <span class="glyphicon-class"><a class="loadprintpreview" href="/wcalificaciones/wd/">Nueva Busqueda</a></span> </button>
</div>
</div>
</div>
