...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('lastResetTime')); ?>:</b>
	<?php echo CHtml::encode($data->lastResetTime); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('resetCount')); ?>:</b>
	<?php echo CHtml::encode($data->resetCount); ?>
	<br />
